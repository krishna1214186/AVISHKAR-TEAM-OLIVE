...
public class NavMap extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener,MapboxMap.OnMapClickListener  {
    ...
    private Button btnStart,btnRoute;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gCoder=new Geocoder(NavMap.this);
        List<Address>[] addressList = new List[]{new ArrayList<Address>()};
        try {
            addressList[0]= gCoder.getFromLocationName("Delhi",1);
        } catch (IOException e) {
            e.printStackTrace();
        }
        Address address = (Address) addressList[0].get(0);

        latfield = address.getLatitude();
        longfield = address.getLongitude();
    }
    ...
    public void onMapReady(@NonNull MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(getString(R.string.navigation_guidance_day), style -> {
            ...
            btnRoute.setOnClickListener(v -> {
              ...
              destination(longfield,latfield);
               //Toast.makeText(NavMap.this, longfield+" "+latfield, Toast.LENGTH_SHORT).show();
...
//        }
//    }
    public void destination(double lng,double lat)
    {

        Point destinationPoint = Point.fromLngLat(lng,lat);//here you place the actual lat lng of destination
...
//        Point destinationPoint = Point.fromLngLat(longfield, latfield);
//        Point originPoint = Point.fromLngLat(locationComponent.getLastKnownLocation().getLongitude(),
//                locationComponent.getLastKnownLocation().getLatitude());
//
//        GeoJsonSource source = mapboxMap.getStyle().getSourceAs("destination-source-id");
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        ...
                        btnStart.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                NavigationLauncher.startNavigation(NavMap.this, options);
                            }
                        });
