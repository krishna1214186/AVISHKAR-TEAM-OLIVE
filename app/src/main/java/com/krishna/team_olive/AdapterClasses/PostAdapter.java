...
//            });
//
//            itemViewHolder.iv_postimage.setImageResource(R.drawable.ic_ads);
//            if(postsData.getImageurl()!=null  && !(postsData.getImageurl().equals("")))
//                Picasso.get().load(postsData.getImageurl()).placeholder(R.drawable.ic_ads).into(itemViewHolder.iv_postimage);
//
